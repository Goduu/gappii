...
function augmentRelationshipWhereInputType({ whereType, fieldName, filters, relationshipAdapter, deprecatedDirectives, features, }) {
    const fields = {};
    if (!relationshipAdapter.isFilterableByValue()) {
        return fields;
    }
    if (!relationshipAdapter.isList || (0, utils_1.shouldAddDeprecatedFields)(features, "arrayFilters")) {
        fields[fieldName] = {
            type: whereType,
        };
    ...
    if (filters) {
        for (const filterField of filters) {
            ...
            if ((0, utils_1.shouldAddDeprecatedFields)(features, "arrayFilters")) {
...
function augmentWhereInputTypeWithRelationshipFields(relationshipAdapter, deprecatedDirectives, features) {
...
function augmentWhereInputTypeWithConnectionFields(relationshipAdapter, deprecatedDirectives, features) {
