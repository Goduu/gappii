...
const getColor = (count: number) => {
    if (count === 0) return '#fffbeb';     // Empty
    if (count <= 1) return '#fde68a';      // Very Light green
    if (count <= 10) return '#fbbf24';      // Light green
    if (count <= 30) return '#d97706';      // Medium green
    if (count <= 50) return '#92400e';      // Dark green
    if (count <= 100) return '#451a03';     // Darker green
    return '#0d3319';
};
