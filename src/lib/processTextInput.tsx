...
export const transformInputIntoData = async (topic: string, subtopic: string, level: string, language: SupportedLanguage, activitiesNumber: string, onError: (error: string) => void) => {
